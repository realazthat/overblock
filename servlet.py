...
From http://code.activestate.com/recipes/577047-bible-verse-quiz-servletpy/,
listed as licensed under the MIT License. Please see
http://opensource.org/licenses/MIT for license details.
...
class HttpServlet(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    server_version = 'HttpServlet/' + BaseHTTPServer.__version__
...
class _HttpServletRequest:
    ...
    def __init__(self, path):
        ...
        self.__dict = urlparse.parse_qs(query, True)
...
class _PrintWriter(StringIO.StringIO):
